...
<div class="col-lg-12">
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <table class="table table-sm table-bordered" id="mortality-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>NIK</th>
...
$(document).ready(function () {
    ...
    var $table = $('#mortality-table').DataTable({
         processing: true,
         serverSide: true,
         responsive: true,
         stateSave: true,
         dom: '<"toolbar">rtp',
         ajax: '{!! route('mortality.source') !!}',
         columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex',width:"2%", orderable : false},
            // {data: 'code', name: 'code',width:"5%", orderable : false},
            {data: 'nik', name: 'nik',width:"5%", orderable : false},
      ...
      $('#mortality-table_wrapper > div.toolbar').html('<div class="row">' +
                '<div class="col-lg-10">'+
                ...
                '</div>'+
                '<div class="col-lg-2">'+
                    '<a href="{{ route("mortality.create") }}" class="btn btn-sm btn-primary shadow-sm float-right" data-toggle="tooltip" title="Tambah Data"><i class="fas fa-plus"></i></a>'+
                '</div>' +
                '</div>');
    ...
    $('#mortality-table').on('click','a.delete-data',function(e) {
        e.preventDefault();
