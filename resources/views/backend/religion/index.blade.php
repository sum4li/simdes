...
<div class="col-lg-12">
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <table class="table table-sm table-bordered" id="religion-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Nama</th>
...
$(document).ready(function () {
    ...
    var $table = $('#religion-table').DataTable({
      ...
      $('#religion-table_wrapper > div.toolbar').html('<div class="row">' +
                '<div class="col-lg-10">'+
                ...
                '</div>'+
                '<div class="col-lg-2">'+
                    '<a href="{{ route("religion.create") }}" class="btn btn-sm btn-primary shadow-sm float-right" data-toggle="tooltip" title="Tambah Data"><i class="fas fa-plus"></i></a>'+
                '</div>' +
                '</div>');
    ...
    $('#religion-table').on('click','a.delete-data',function(e) {
        e.preventDefault();
